    ...
    */
    ...
    public function scripts() {
        ...
        if(
            ...
            wp_enqueue_style(sprintf('%s-styles', self::BLOCK_NAMESPACE), HEADLAB_DIR_URI . '/assets/admin/metaboxes/style.css', array());
            wp_enqueue_script(sprintf('%s-scripts', self::BLOCK_NAMESPACE), HEADLAB_DIR_URI . '/assets/admin/metaboxes/script.js', array('jquery'));
        }
    }
